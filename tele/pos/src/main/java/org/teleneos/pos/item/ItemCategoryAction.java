...
public class ItemCategoryAction extends DefaultAction implements
		ModelDriven<ItemCategoryActionModel> {
	...
	public ActionResult itemCategoryList() {
		model.setItemCategories(itemCategoryService.findByKeyword(model.getQ(),
