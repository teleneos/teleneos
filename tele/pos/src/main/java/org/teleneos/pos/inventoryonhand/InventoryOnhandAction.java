...
public class InventoryOnhandAction extends DefaultAction implements
		ModelDriven<InventoryOnhandActionModel> {
	...
	public ActionResult inventoryOnhandList() {
		model.setInventoryOnhands(inventoryOnhandService.findByKeyword(
