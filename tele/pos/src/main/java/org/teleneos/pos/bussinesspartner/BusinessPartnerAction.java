...
public class BusinessPartnerAction extends DefaultAction implements
		ModelDriven<BusinessPartnerActionModel> {
	...
	public ActionResult businessPartnerList() {
		model.setBusinessPartners(businessPartnerService.findByKeyword(
