 ...
 * 
 */
public class TelecentreClientDetail {
	private Set<String> maintenances = new HashSet<String>();
	...
	public Set<String> getMaintenances() {
		return maintenances;
	}

	public void setMaintenances(Set<String> maintenances) {
