...
import net.bogor.itu.repository.pos.ItemRepository;
...
public class ItemImplService implements ItemService {
	...
	@Override
	public EntityListWrapper<Item> findByKeyword(String keyword,String order,String orderBy, int limit,
			int page) {
		if (StringUtils.isBlank(keyword))
			return itemRepository.findAll(limit, page);
		return itemRepository.findByKeyword(keyword,order,orderBy, limit, page,"OR");
	}
