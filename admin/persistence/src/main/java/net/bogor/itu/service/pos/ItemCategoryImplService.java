...
import net.bogor.itu.repository.pos.ItemCategoryRepository;
...
public class ItemCategoryImplService implements ItemCategoryService{
	...
	@Override
	public EntityListWrapper<ItemCategory> findByKeyword(String keyword,String order,String orderBy,
			int limit, int page) {
		if (StringUtils.isBlank(keyword))
			return itemCategoryRepository.findAll(limit, page);
		return itemCategoryRepository.findByKeyword(keyword,order,orderBy,limit, page,"OR");
	}
