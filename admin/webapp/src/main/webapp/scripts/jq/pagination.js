	...
	var methods = {
		init: function(options) {
			var o = $.extend({
				...
				ellipseText: '&hellip;',
				cssStyle: 'light-theme btn-group',
				selectOnClick: true,
		...
		_draw: function() {
			...
			if (interval.start > 0 && o.edges > 0) {
				...
				if (o.edges < interval.start && (interval.start - o.edges != 1)) {
					$panel.append('<span class="ellipse btn">' + o.ellipseText + '</span>');
		...
		_appendItem: function(pageIndex, opts) {
			...
			if (pageIndex == o.currentPage || o.disabled) {
				$link = $('<span class="current active btn">' + (options.text) + '</span>');
			} else {
				$link = $('<a href="' + o.hrefTextPrefix + (pageIndex + 1) + o.hrefTextSuffix + '" class="page-link btn">' + (options.text) + '</a>');
				$link.click(function(){
