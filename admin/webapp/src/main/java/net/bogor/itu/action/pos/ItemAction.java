...
public class ItemAction extends DefaultAction implements ModelDriven<ItemActionModel>{
	...
	public ActionResult itemList() {
		model.setItems(itemService.findByKeyword(model.getQ(),null,"ASC", model.getMax(),
				model.getPage() - 1));

		return new ActionResult("freemarker",
				"/view/pos/item/item-list.ftl");
	}
